...
public class DataSourceConfig {
	...
	private static final String Entity_Package = "org.springframework.boot.peach.mybatis.entity";
	...
	@Bean(name = "peachSqlSessionFactory")
	@Primary
	public SqlSessionFactory webPageSqlSessionFactory(@Qualifier("peachDataSource") DataSource webPageDataSource)
			throws Exception {
